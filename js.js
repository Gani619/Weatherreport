...
form.addEventListener('submit', function (e) {
    ...
    const apiID = `b13d1082f695a0431813214e3b807a66`;
    // API URL = api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=b13d1082f695a0431813214e3b807a66
    ...
    fetch(url).then((response) => {
        ...
        // Updating the Images according to the weather report .
        if (weatherMain == 'Clear') {
            image.src = `./images/clear cloud.png`
